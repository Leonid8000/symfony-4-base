...
// Returns the private 'App\Repository\PollRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PollRepository.php';

return $this->privates['App\\Repository\\PollRepository'] = new \App\Repository\PollRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
